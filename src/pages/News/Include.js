    ...
    return (
        <Layout>
            ...
            <div className="container">
                <chakra.h1 color="blue">The Borderlands Initiative to be included in the UK government’s budget statement</chakra.h1>
                <chakra.h2 color="blue">With Scottish Government support, this project overcomes political and cross-border differences to provide tremendous opportunities for the area’s future economic stability
                </chakra.h2>
                ...
                <chakra.h2 color="blue">A Borderlands Initiative spokesperson said:</chakra.h2>
                ...
                <chakra.h2 color="blue">Additional quotes:</chakra.h2>
                <chakra.h2 color="blue">Leader of Carlisle City Council, Cllr Colin Glover, said:</chakra.h2>
                ...
                <chakra.h2 color="blue">Elaine Murray, Leader of Dumfries and Galloway Council said:</chakra.h2>
                ...
                <chakra.h2 color="blue">Peter Jackson, Leader of Northumberland County Council said:</chakra.h2>
                ...
                <chakra.h2 color="blue">Councillor Shona Haslam, Leader of Scottish Borders Council, said:</chakra.h2>
